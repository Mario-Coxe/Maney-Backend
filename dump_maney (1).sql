...
--
-- Table structure for table `atm_agents`
--

DROP TABLE IF EXISTS `atm_agents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `atm_agents` (
  `atm_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`atm_id`),
  KEY `atm_agents_user_id_foreign` (`user_id`),
  CONSTRAINT `atm_agents_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `atms` (
  ...
  `has_cash` int DEFAULT NULL,
  `has_paper` int DEFAULT NULL,
  `id_street` int NOT NULL,
  `id_municipe` int DEFAULT NULL,
  `updated_at` varchar(45) DEFAULT NULL,
  `status` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `munipice` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id_street` (`id_street`),
  KEY `id_municipe` (`id_municipe`),
  CONSTRAINT `atms_ibfk_1` FOREIGN KEY (`id_street`) REFERENCES `streets` (`id`),
  CONSTRAINT `atms_ibfk_2` FOREIGN KEY (`id_municipe`) REFERENCES `municipes` (`id`)
...
CREATE TABLE `histories` (
  ...
  `name` varchar(255) NOT NULL,
  `address` varchar(255) NOT NULL,
  `has_cash` int NOT NULL,
  `has_paper` int NOT NULL,
...
--
-- Table structure for table `municipes`
--

DROP TABLE IF EXISTS `municipes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `municipes` (
  ...
  CONSTRAINT `municipes_ibfk_1` FOREIGN KEY (`id_province`) REFERENCES `provinces` (`id`)
...
CREATE TABLE `streets` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_municipe` (`id_municipe`),
  CONSTRAINT `streets_ibfk_1` FOREIGN KEY (`id_municipe`) REFERENCES `municipes` (`id`)
...
CREATE TABLE `users` (
  ...
  `tipo_usuario` enum('cliente','agente','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cliente',
...
-- Dump completed on 2024-05-12 14:07:27
