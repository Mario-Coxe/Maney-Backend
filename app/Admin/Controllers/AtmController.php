...
class AtmController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('municipe.name', __('Municipe')); // Display the name of the municipe
    ...
    protected function form()
    {
        ...
        $streets = \App\Models\Street::pluck('name', 'id'); // Obtém os nomes das ruas da tabela "streets"
